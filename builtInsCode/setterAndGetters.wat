(module
    ...
    (func $i32set (type $2) (param $arrayPointer i32) (param $index i32) (param $elementValue i32) (result i32)
        ...
        (i32.store (i32.add (i32.add (local.get $arrayPointer) (i32.const 4)) (i32.mul (local.get $index) (i32.const 4))) (local.get $elementValue))
    ...
    (func $i8set (type $2) (param $arrayPointer i32) (param $index i32) (param $elementValue i32) (result i32)
        ...
        (i32.store8 (i32.add (i32.add (local.get $arrayPointer) (i32.const 4)) (local.get $index)) (local.get $elementValue))
        (local.get $arrayPointer)
    )
    ...
    (func $f32set (type $3) (param $arrayPointer i32) (param $index i32) (param $elementValue f32) (result i32)
        ...
        (f32.store (i32.add (i32.add (local.get $arrayPointer) (i32.const 4)) (i32.mul (local.get $index) (i32.const 4))) (local.get $elementValue))
        (local.get $arrayPointer)
    ) 
)